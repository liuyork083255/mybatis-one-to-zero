 ...
 * one-to-zero:
 *  參考：http://www.mybatis.org/mybatis-3/zh/configuration.html
 *
...
public class Configuration {
   ...
   * 如果同时 找到带有databaseId 和不带 databaseId 的相同语句，则后者会被舍弃
   * 參考：http://www.mybatis.org/mybatis-3/zh/configuration.html#databaseIdProvider
   */
  ...
  /**
   * 记录 mybatis mapper 类和对应的mapper工厂
   */
  ...
  /**
   * key：liu.york.UserMapper.selectUser
  ...
  /**
   * 记录 mapper resource 资源
   * <mappers>
   *    <mapper resource="demo/demo1/UserMapper.xml" />
   * </mappers>
   * 下的 demo/demo1/UserMapper.xml 字符串
   */
